...
<div class="flex flex-col h-full w-full fixed top-0 bottom-0 left-0 right-0 justify-center items-center">
    ...
    <div class="self-end w-full py-10 grid grid-cols-3 gap-4 responsive-padding">
        ...
        <Button class="w-full col-span-2" on:click={signup} href="/mobile/onboarding/account-type">
            Get started
        </Button>

        <Button variant="outline" class="col-span-3" href="/mobile/onboarding/login?mode=login">
