...
import NDK, { NDKArticle, NDKEvent, NDKKind, NDKRelay, NDKRelayStatus, PublishError, type NostrEvent } from "@nostr-dev-kit/ndk";
...
export async function addToListOfSupporters(
    ...
    debug("addToListOfSupporters", {creatorPubkey, subscriptionEvent: subscriptionEvent.rawEvent()});
    ...
    const alreadyPresent = event.getMatchingTags("p")
