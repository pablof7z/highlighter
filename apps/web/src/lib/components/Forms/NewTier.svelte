...
<label class="text-white text-base font-medium flex flex-col gap-2 items-start border border-neutral-800 px-4 py-3 rounded-xl">
    <div class="w-full flex-col justify-start items-start inline-flex">
        ...
        <Textarea
            ...
            class="w-full !bg-transparent border border-neutral-800 rounded-xl rounded-t-none resize-none text-lg text-white tracking-widest"
