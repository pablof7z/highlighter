<script lang="ts">
	import { NDKArticle, NDKEvent, NDKFilter, NDKKind, NDKRelaySet, NDKSimpleGroupMemberList, NDKSimpleGroupMetadata, NDKSubscriptionTier, NDKTag, NDKVideo } from "@nostr-dev-kit/ndk";
    ...
    export let groups: Writable<Record<string, Groups.GroupData>> | undefined = undefined;
    ...
    onMount(() => {
        ...
        tiers = deriveStore<NDKSubscriptionTier>(events, NDKSubscriptionTier);
    });
