<script lang="ts">
    import { NDKSimpleGroup, NDKSimpleGroupMemberList, NDKSimpleGroupMetadata, NDKSubscriptionTier } from "@nostr-dev-kit/ndk";
...
<div class="flex flex-col gap-3 items-center justify-stretch w-full">
